...
// Verificar que haya datos de publicación
if (!isset($_SESSION['producto_publicado'])) {
    redireccionar('/');
}

$producto = $_SESSION['producto_publicado'];
$producto_id = $producto['id'];
$titulo_producto = $producto['titulo'];

// Limpiar sesión después de leer
unset($_SESSION['producto_publicado']);
...
<div class="success-container">
    <div class="success-card">
        ...
        <h1 class="success-title">¡Publicado Exitosamente!</h1>
        <p class="success-subtitle">Tu anuncio ya está visible para miles de compradores</p>
